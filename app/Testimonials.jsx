...
export default function Testimonials() {
  ...
  const testimonials = [
    ...
    {
      company: "Luxara",
      text: `“Very professional, top notch communication & absolute pleasure to work. Highly recommended!"`,
      name: "Danny P",
    ...
    {
      company: "HBIT App",
      text: `“Wavespace delivered stunning and professional mobile design quickly. Highly recommend their excellent work!"`,
      name: "Mark Gawlyk",
      role: "Co-founder & CTO",
