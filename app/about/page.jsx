...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <nav className="w-full bg-white sticky top-0 z-30 border-b border-gray-100">
        <div className="max-w-[1200px] mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="ml-4">
            <a
              href="#"
              className="inline-block bg-gradient-to-r from-[#4f3bff] to-[#1a4bff] text-white px-4 py-2 rounded-full font-medium shadow-sm"
            >
              Contact Us →
            </a>
          </div>
      ...
      {/* HERO */}
      <section className="hero px-6 md:px-12 py-20">
        <div className="max-w-[1200px]  items-start">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
              Designed for billions, and we are the team behind{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#ff8a3d] via-[#ff4bd1] to-[#4f3bff]">
                future unicorns.
              </span>
            </h1>
            ...
            <div className="mt-6 rounded-xl overflow-hidden shadow-sm">
              {/* hero image: using external CDN image (original) */}
              <img
          ...
          <div className="flex items-center justify-center md:justify-end">
            {/* small summary or CTA area could go here (kept clean per original) */}
          </div>
        </div>
      </section>

      {/* TRUST STRIP */}
      <section className="trust bg-gray-50 py-8">
        <div className="max-w-[1200px] mx-auto px-6 text-center text-lg">
          Trusted by 500+ global companies
        </div>
      </section>

      {/* STATS */}
      <section className="stats-section bg-gray-100 py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="stats-heading text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-extrabold">
              Bold design, billion-dollar proof. We measure impact,{" "}
          ...
          <div className="stats-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="card bg-white rounded-2xl p-8 min-h-[240px] border border-gray-200">
              ...
              <p className="text-gray-600 mt-3">uplift in conversions</p>
            </div>
            <div className="card bg-white rounded-2xl p-8 min-h-[240px] border border-gray-200">
              <h3 className="text-2xl md:text-3xl font-extrabold">100M+</h3>
              <p className="text-gray-600 mt-3">users reached</p>
            </div>
            <div className="card bg-white rounded-2xl p-8 min-h-[240px] border border-gray-200">
              <h3 className="text-2xl md:text-3xl font-extrabold">140+</h3>
              <p className="text-gray-600 mt-3">Awards recognised globally</p>
            </div>
            <div className="card bg-white rounded-2xl p-8 min-h-[240px] border border-gray-200">
      ...
      {/* WHY SECTION */}
      <section className="why py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="left">
            <img
              src="https://cdn.prod.website-files.com/6655d16113e6966ef4eb1041/6816e7ca55955501354f28ca_image1-p-1080.webp"
              alt="why"
          ...
          <div className="right">
            ...
            <ul className="feature-list space-y-3">
              <li className="flex justify-between items-center border-b border-gray-100 py-4">
                <span className="font-medium">Startup-Speed Process</span>
                <span className="text-slate-400">→</span>
              </li>
              <li className="flex justify-between items-center border-b border-gray-100 py-4">
                <span className="font-medium">SaaS, AI & Web3 Experts</span>
                <span className="text-slate-400">→</span>
              </li>
              <li className="flex justify-between items-center border-b border-gray-100 py-4">
              ...
              <li className="flex justify-between items-center border-b border-gray-100 py-4">
                <span className="font-medium">Design That Performs</span>
                <span className="text-slate-400">→</span>
              </li>
              <li className="flex justify-between items-center border-b border-gray-100 py-4">
                <span className="font-medium">Flexible Engagement Models</span>
                <span className="text-slate-400">→</span>
              </li>
            </ul>
          </div>
      ...
      {/* SERVICE BLOCKS */}
      <section className="service-block blue py-20">
        <div className="max-w-[1200px] mx-auto px-6">
      ...
      {/* Web Design service block (yellow) */}
      <section className="service-block yellow py-20">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="content bg-[#f3c800] rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 text-black">
            ...
            <div className="w-[380px] flex-shrink-0">
              <img
                src="https://cdn.prod.website-files.com/6655d16113e6966ef4eb1041/691177a5b7f0575f57b73716_b2b-ui-ux-design%20(1).webp"
                alt="webdesign"
                className="rounded-xl w-full h-auto object-cover"
              />
            </div>
      ...
      {/* MVP block (orange) */}
      <section className="service-block orange py-20">
        <div className="max-w-[1200px] mx-auto px-6">
      ...
      {/* FOUNDER */}
      <section className="founder bg-black text-white py-24">
        <div className="max-w-[1200px] mx-auto px-6">
      ...
      {/* CREATIVES */}
      <section className="creatives py-24">
        <div className="max-w-[1200px] mx-auto px-6">
